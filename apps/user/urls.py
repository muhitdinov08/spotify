...
from apps.user.api_endpoints.User import UserCreateView, UserActivateView, UserUpdatePasswordViewSet, \
    UserUpdatePasswordLink
...
urlpatterns = [
    ...
    # path('user-update-password-link/', UserUpdatePasswordLink.as_view(), name="user-password-link"),
    # path('user-update-password/<str:token>', UserUpdatePasswordViewSet.as_view(), name="user-password-update"),
